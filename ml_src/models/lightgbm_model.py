...
class LightGBMModel(BaseModel):
    ...
    def build_model(self) -> Any:
        ...
        self.logger.info("LightGBM model parameters configured")
        return None
    ...
    def fit(self, X_train: np.ndarray, y_train: np.ndarray,
        ...
        if is_classification:
            ...
            self.logger.info("Using LGBMClassifier")
        else:
            self.model = lgb.LGBMRegressor(**self.model_params)
            self.logger.info("Using LGBMRegressor")
    ...
    def is_classifier(self) -> bool:
        ...
        return isinstance(self.model, lgb.LGBMClassifier) if self.model else False